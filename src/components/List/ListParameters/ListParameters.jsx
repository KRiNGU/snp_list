...
const ListParameters = () => (
    <li className={styles.parameters}>
        ...
        <div className={classnames(styles.parameter, styles.phoneNumber)}>Phone Number</div>
        <div className={classnames(styles.parameter, styles.placement)}>Place of Residence</div>
    </li>
);
